...
class Task(_Data):
    def __init__(self, task_id: str, parent_task_id="None", task_description="None"):
        """
        ...
        self.task_type = "None"  # Type of the task, can be either Original Task, General Inquiry, System Function,
        # or App-Related Task.
        self.children_ids = []  # List of identifiers of the sub-tasks or steps.

        # Only used when task declaration
        self.conversation_clarification = [{'role': 'system', 'content': SYSTEM_PROMPT}]  # List of conversations that
        # occurred during multiple turns of task clarification.
        self.res_clarification = dict()  # Final json result of task clarification.
        # (we don't use NoneType as it can't be str())
        ...
        self.conversation_automation = [{'role': 'system', 'content': SYSTEM_PROMPT}]  # List of conversations that
        # occurred during multiple turns of task automation.
