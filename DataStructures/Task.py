...
class Task(_Data):
    def __init__(self, task_id, user_id=None, parent_task_id=None, task_description=None):
        ...
        self.conversation_clarification = [{'role': 'system', 'content': SYSTEM_PROMPT}]    # List of conversations that occurred during multiple turns of task clarification.
        ...
        self.conversation_automation = [{'role': 'system', 'content': SYSTEM_PROMPT}]       # List of conversations that occurred during multiple turns of task automation.
    ...
    def load_task_from_json(self, task_json):
        """
        Load and set attribute from dict
        Args:
            task_json (dict): json dict data with task attributes stored
        Returns:
    ...
    def wrap_task_to_json(self):
        """
        Wrap all attributes to store as a dict
        Returns:
