...
class _IconClassifier:
    def __init__(self, model_path='ModelManagement/icon_classifier_model_results/best-0.93.pt', class_path=
    'ModelManagement/icon_classifier_model_results/iconModel_labels.json'):
