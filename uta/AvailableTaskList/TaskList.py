...
class TaskList:
    def __init__(self, model_manager):
        ...
        self.app_list = ['Android Settings'] * 18 + ['Phone'] + ["Phone Camera"] + ["Google Photo"] * 5 + ["Gmail"] + ["Android File"] * 2
        self.step_list = ["Open Settings > search and select Screen lock > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search and select Screen lock > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search Fingerprint > select related option > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search Fingerprint > select related option > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search and select Accessibility > Tap haptics > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search and select Sounds and Vibration > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search and select Sounds and Vibration > Ringtone > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search and select Accessibility > Tap Vibration > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search and select Accessibility > Tap Vibration > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search and select Sound & vibration > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > search and select Sound & vibration > Default notification sound > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > tap Notifications > the task is Almost Completed and STOP THE TASK.",
                          "Open Settings > Search and select Font size > the task is Almost Completed and STOP THE TASK.",
                          "open Settings > search and select Date > the task is Almost Completed and STOP THE TASK.",
                          "open Settings > search and select Time > the task is Almost Completed and STOP THE TASK.",
                          "open Settings > search and select Caller ID > the task is Almost Completed and STOP THE TASK.",
                          "open Settings > search and select Sound & vibration. > Select Do Not Disturb > the task is Almost Completed and STOP THE TASK.",
                          "open Settings > Tap Display > Tap Lock screen > the task is Almost Completed and STOP THE TASK.",
                          "Open Phone app > Tap the three dots in the top-right > Tap Settings and then Blocked numbers > the task is Almost Completed and STOP THE TASK.",
                          "Open the Camera",
                          "Open up your phone's Gallery app > Find the photo you want to use and open it > Tap the three dots in the top-right > the task is Almost Completed and STOP THE TASK.",
                          "Open Google Photos",
                          "Open Google Photos > Click the photo you want to delete > the task is Almost Completed and STOP THE TASK.",
                          "Select an image in Google Photos and tap the Edit button > the task is Almost Completed and STOP THE TASK.",
