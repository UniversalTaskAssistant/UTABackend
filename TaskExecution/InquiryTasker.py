...
class InquiryTasker:
    ...
    def execute_inquiry_task(self, conversation):
        ...
        # try:
        #     answer = self.__model_manager.create_llm_conversation(conversation)
        #     history = self.__model_manager.get_llm_conversations()
    ...
    def reset_inquiry_tasker(self):
        ...
        # self.__model_manager.reset_llm_conversations()
